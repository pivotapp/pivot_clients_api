...
DEPS = cowboy fast_key simple_env cowboy_route_loader simple_sup sync erlenv cowboy_env cowboy_request_id cowboy_fun jsx cowboy_cors privdir pivot
...
dep_pivot = https://github.com/CamShaft/pivot.erl.git master
